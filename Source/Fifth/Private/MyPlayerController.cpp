...
void AMyPlayerController::ChatToServer(FString Text)
{
...
void AMyPlayerController::HitCharacter(const int& sessionID, const ANetCharacter* DamagedCharacter)
{
...
void AMyPlayerController::RecvChat(const string* chat_)
{
	if (chat_ != nullptr)
	{
		chat = chat_;
...
void AMyPlayerController::RecvNewPlayer(cCharactersInfo* NewPlayer_)
{
